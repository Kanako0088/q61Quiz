...
@section('content')
  <div id="loader-bg">
    <div id="loader" class="is-hide">
        <p><img class="logo" src="{{ asset('images/top/logo.svg') }}"
          width="200" /><br>
        </p>
    </div>
  </div>
  ...
  <div class="main top">
      <audio id="bgm" muted loop autoplay src="{{ asset('images/media/SIKAMO_audio.mp3')}}" type="audio/mp3"></audio>
      <div class="box">
        <div id="mv">
        </div>
      </div>
      ...
      <div class="btnarea" id="btnarea">
        <a class="btn" href="{{ route('attention') }}">START</a>
      </div>
    </div>
